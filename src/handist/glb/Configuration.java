...
public final class Configuration implements Serializable {
   ...
   * object in one process is checked for propagation to neighboring processes.
   * Only relevant if calling {@link GLBcomputer#computeWhisperedResult}.
   */
   ...
   * cannot be changed during the computation. The number of concurrent workers
   * can be set using {@value #GLBM_WORKERS}. If not specified, the value
   * returned by {@link Runtime#availableProcessors()} will be used.
   */
  public final int x;
