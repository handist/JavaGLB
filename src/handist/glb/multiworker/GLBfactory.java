...
public final class GLBfactory {
   ...
   * computation and returns an instance to which computation can be submitted.
   * <p>
  ...
  public static GLBcomputer setupGLB() throws ReflectiveOperationException {
    ...
    final long whisperInterval = Long
        .parseLong(System.getProperty(Configuration.GLBM_WHISPERING_INTERVAL,
    ...
    return PlaceLocalObject.make(places(),
        () -> new GLBcomputer(workUnit, randomSteals, strategy, nbWorkers,
            tuningInterval, tuner, whisperInterval));
  }
}
