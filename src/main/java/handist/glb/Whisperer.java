...
public interface Whisperer<I extends Serializable, R extends Fold<R> & Serializable> {
     ...
     * worth sharing with the other java processes taking part in the
     * distributed computation.
     *
     * @param source
     *            shared object from which the information (if any) would come
     *            from
     *
     ...
     *
     * @param source
     *            shared object instance from which the information is going to
     *            come from
