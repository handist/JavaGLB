...
public class ParallelNQueens {
    ...
    /**
     * Launches a parallel execution of the N-Queens problem using the global
     * load balancer.
     *
    ...
    public static void main(String[] args) {
        ...
        if (warmupSize > 0) {
            ...
            System.out.println("WARMUP TIME; "
                    + (warmupLog.initializationTime + warmupLog.computationTime)
                            / 1e9
                    + ";");
        ...
        System.err.println("N=" + size + "; Configuration: "
        ...
        for (int i = 0; i < repetitions; i++) {
            ...
            final int SIZE = size; // variable needs to be final for
                                   // serialization of
                                   // the lambda in the NQueens constructor

            final Answer result = computer.compute(initialBag,
                    () -> new Answer(SIZE), () -> new NQueens(SIZE));
            ...
            System.err.println(i + "/" + repetitions + ";" + result.solutions
                    + ";" + treeSize + ";" + log.initializationTime / 1e9 + ";"
