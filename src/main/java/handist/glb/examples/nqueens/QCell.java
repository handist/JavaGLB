...
public class QCell {
     ...
     * left to {@code null}.
     * <p>
     * There is no use for a cell to have a name, therefore {@link #name} is
     * left to {@code null}. Likewise the {@link #size} value is left to the
     * default 0 but is unused under normal operation.
     *
     * @param i
     ...
     * @param i
     *            index of the {@link QCell} instance in
     *            {@link QCoverMatrix#cells}
    ...
    /**
     * Pointer to the cell used as header for the column in which this instance
     * is located
     */
    QCell column;
    ...
    /**
     * Makes all the elements in the row this cell belongs to fade from the
     * cover matrix by linking the element above and below in their respective
     * column. This method is used to discard rows that would cover a column
     * already covered by an other row.
     */
    ...
    /*
     * Returns a String containing in one line the columns of the matrix that
     * are covered by the row this cell belongs to.
     */
    @Override
