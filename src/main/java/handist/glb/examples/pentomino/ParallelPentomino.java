...
public class ParallelPentomino {
    ...
    private static Options commandOptions() {
        ...
        opts.addRequiredOption("h", "height", true,
                "board height (6, 9 or 10)");
    ...
    public static void main(String[] args) {
        ...
        if (width * height == 60) {
            ...
            System.err.println(
                    "Board surface should be either 60 or 90 square tiles");
            return;
        }
        ...
        // Print the solution
        System.err.println("Solution to H:" + height + " W:" + width + "; "
                + ans.solutions + ";");
