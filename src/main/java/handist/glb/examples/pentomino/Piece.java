...
public abstract class Piece implements Serializable {
    ...
    /**
     * Returns a String that represents the shape described by the array given
     * as parameter.
     *
     * @param a
     ...
     * @return potentially multiple line string that can be printed on the
     *         console
     */
     ...
     *
     * @param i
     *            the number of the variation whose array description is
     *            desired, 0 &le; i &lt; {@link #variations()}.
     ...
     *
     * @param width
     *            the width of the board on which the pieces are meant to be
     *            placed
     */
    ...
    /**
     * Returns the number of different ways in which this piece can be
     * positioned.
     *
