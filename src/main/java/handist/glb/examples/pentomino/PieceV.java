...
public class PieceV extends Piece {
  ...
  int[] first;
  /**
   * Second variation of the V piece actually used in the Pentomino exploration
   */
  int[] second;
  /**
   * Third variation of the V piece actually used in the Pentomino exploration.
   * May actually be unused if symmetry elimination is desired for a particular
   * exploration.
   *
  ...
  int[] third;
  /**
   * Fourth variation of the V piece actually used in the Pentomino exploration.
   * May actually be unused if symmetry elimination is desired for a particular
   * exploration.
   *
   * @see #removeHorizontalSymmetry()
