...
public class TspParser {
    ...
    public static TspProblem parseFile(String path) throws IOException {
        ...
        /**
         * Extracting a bound function giving the minimum cost left to complete
         * a path
         */
     ...
     *            instance. Must be positive and smaller or equal to the number
     *            of cities available in the file.
    ...
    public static TspProblem parseFile(String path, int citySubset)
        ...
        problem.boundFunction = Arrays.copyOf(problem.boundFunction,
                citySubset);
