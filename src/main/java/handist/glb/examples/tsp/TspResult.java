...
public class TspResult implements Fold<TspResult>, Serializable {
  ...
  /**
   * Tracks if a smaller value of {@link #bestSolution} was found since the last
   * time method {@link #getInformation()} was called.
   */
  ...
  /**
   * Indicates if this instance contains a better bound then the value held the
   * least time method {@link #getInformation()} was called.
   *
  ...
  /**
   * If the provided parameter has a bound value lower than the value currently
   * held by {@link #bestSolution}, updates {@link #bestSolution} with this new
   * value. Otherwise, does not do anything.
   *
   * @param info
