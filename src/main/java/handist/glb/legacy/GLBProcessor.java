...
public interface GLBProcessor {
   ...
   * <p>
   * The {@link GLBProcessor} will handle the work splitting and distribution as
   * well as the load-balancing operations that need take place during the
   * computation.
   *
   * @param <R>
   ...
   * the last computation performed by the Global Load Balancer.
   *
