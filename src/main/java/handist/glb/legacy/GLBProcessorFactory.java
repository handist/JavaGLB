...
public class GLBProcessorFactory {
     ...
     * <li>The number of random steal attempts performed before turning to the
     ...
     * @param stealAttempts
     *            number of random steals attempted before resulting to the
     *            lifeline scheme
     * @param strategy
     *            the lifelines strategy to be used in this GLBProcessor
     *            instance
     * @return a new computing instance
     */
    public static <S extends LifelineStrategy & Serializable> GLBProcessor GLBProcessor(
        ...
        final GLBProcessor glb = PlaceLocalObject.make(places(),
                () -> new GenericGLBProcessor(workUnit, stealAttempts,
                        strategy));
        return glb;
    }
}
