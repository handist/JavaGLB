...
public class Logger implements Serializable {
     ...
     * measured in nanoseconds to String-displayed time-interval in
     * milliseconds.
     *
     * @param nanoInterval
    ...
    /**
     * Resets all members of this instance to make it fit for recording the
     * events of an other distributed computation.
     */
    public void reset() {
        stealsAttempted = 0;
        stealsSuccess = 0;
    ...
    /**
     * To be called when a worker thread stops, either because it is waiting for
     * a steal answer or has run out of tasks.
     */
