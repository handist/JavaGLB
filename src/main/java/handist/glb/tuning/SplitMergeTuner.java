 ...
 * computed. This makes the {@link SplitMergeTuner} make its decision on the most recent
 * logger data.
 *
 ...
 * set the value to {@link Integer#MAX_VALUE}.
 *
 *
 * @author Patrick Finnerty
 *
 */
public class SplitMergeTuner implements Tuner, Serializable {
    ...
    /**
     * Value of member {@link PlaceLogger#interQueueSplit} the last time the
